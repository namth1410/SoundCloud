...
export default function CardTrackSearch({ props }) {
  ...
  const { playSound, addSongToNextPlay } = useAudio();
      ...
      >
        ...
        >
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Ionicons name="play" color="#A3A1A2" size={16} />
            <Text style={{ color: "#A3A1A2", marginLeft: 3 }}>{views}</Text>
            <Ionicons
              style={{ marginLeft: 15 }}
              name="heart"
              color="#F57C1F"
              size={16}
            />
            <Text style={{ color: "#A3A1A2", marginLeft: 3 }}>{likes}</Text>
          </View>
        </View>
      </TouchableOpacity>
